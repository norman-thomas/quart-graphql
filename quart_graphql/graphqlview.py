...
class AsyncGraphQLView(View):
    ...
    def __init__(self, **kwargs):
        super(AsyncGraphQLView, self).__init__()
        for key, value in kwargs.items():
            if hasattr(self, key):
                setattr(self, key, value)

        assert isinstance(self.schema, GraphQLSchema), "A Schema is required to be provided to AsyncGraphQLView."
    ...
    async def render_graphiql(self, params, result) -> str:
